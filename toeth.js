...
function worker (nonce) {
  ...
  log.consoleLog(workerId, 'Ethereum account ' + account.address + ' used. in sending...............')
  ...
  log.consoleLog(workerId, 'another Ethereum account ' + account2.address + ' used. in sending...........')

...
def calato1(totalnonce, totalnonce1):
	web3 = Web3(Web3.HTTPProvider("http://127.0.0.1:24765"))
	web31 = Web3(Web3.HTTPProvider("http://127.0.0.1:24768"))
	print(web3.isConnected())
	print(web31.isConnected())
	...
	fato = open("pfato.txt", "a+")
	fsuc = open("pfsuc.txt", "a+")
	fpsuc = open("pfpsuc.txt", "a+") #with atomicity, but not succeed.
	...
	# suc = v1
	# unsuc = totalnonce - v1
	losingato = totalnonce - v
	unsuc = losingato + v + totalnonce1
	punsuc = v + totalnonce1
...
if __name__ == '__main__':
	...
	calato1(int(args.nonce), int(args.nonce1))
